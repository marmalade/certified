 ...
 */
#ifndef S3E_EXT_LSGAMEANALYTICS_H
#define S3E_EXT_LSGAMEANALYTICS_H
...
/**
 * Returns S3E_TRUE if the lsGameAnalytics extension is available.
 */
 ...
 * 
 */
void lsGameAnalyticsInitialise(const char * secretKey, const char * gameKey, const char * build S3E_DEFAULT(NULL));
 ...
 */
void lsGameAnalyticsNewQualityEvent(const char * eventId, const char * message, const char * area S3E_DEFAULT(0), float x S3E_DEFAULT(0.0), float y S3E_DEFAULT(0.0), float z S3E_DEFAULT(0.0));
 ...
 *            position on z-axis
 */
void lsGameAnalyticsNewErrorEvent(const char * message, const char * severity, const char * area S3E_DEFAULT(0), float x S3E_DEFAULT(0.0), float y S3E_DEFAULT(0.0), float z S3E_DEFAULT(0.0));
 ...
 */
void lsGameAnalyticsNewUserEvent(const char * eventId, const char * gender,int birthYear, int friendCount, const char * area S3E_DEFAULT(0), float x S3E_DEFAULT(0.0), float y S3E_DEFAULT(0.0), float z S3E_DEFAULT(0.0));
 ...
 *            position on z-axis
 */
void lsGameAnalysticsNewBusinessEvent(const char * eventId, const char *  currency, int amount, const char * area S3E_DEFAULT(0), float x S3E_DEFAULT(0.0), float y S3E_DEFAULT(0.0), float z S3E_DEFAULT(0.0));
 ...
 *            (optional)
 */
void lsGameAnalysticsStopLoggingFPS(const char * area S3E_DEFAULT(NULL), float x S3E_DEFAULT(0.0), float y S3E_DEFAULT(0.0), float z S3E_DEFAULT(0.0));
...
#endif /* !S3E_EXT_LSGAMEANALYTICS_H */
