...
/*
	Note: Some parts of the following source are covered by a separate
	copyright to that above. See SUB-COPYRIGHT below:
 */
...
public class AsyncHttpClient {
   ...
   /**
    ...
    /*  SUB-COPYRIGHT
       Android Asynchronous Http Client - Twice Circled Update 28/02/13
    ...
    */ 
    ...
    // The following method is added so that headers can be added to a single post command
    // that also supports HttpEntity.
     ...
     * @param responseHandler the response handler instance that should handle the response.
     */
    public void post(Context context, String url, HttpEntity entity, String contentType,Header[] headers, AsyncHttpResponseHandler responseHandler) {
